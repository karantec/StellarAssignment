  ...
  return (
    <>
      <div className='flex flex-1 items-center justify-center gap-[1rem] mt-4 mb-5'>
        <div className='flex flex-col border border-slate-500 p-[3rem] rounded-md relative'>
        ...
        <div className='flex flex-col border border-slate-500 p-[3.5rem] rounded-md relative'>
          <div className='flex items-center justify-between'>
            <h1 className='text-xl font-bold'>On Velocity</h1>
            <div className='w-3 h-3 mb-4 bg-red-500 rounded-full'></div>
          </div>
          <div className='flex flex-col'>
            <div className='flex flex-1 justify-center items-center gap-[4rem]'>
