...
import { Menu, X, MessageCircleCode,Settings  , ChevronRight ,Bell } from 'lucide-react'
    ...
    <div className="relative w-full bg-white">
      <div className="mx-auto flex max-w-7xl items-center justify-center  px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block">
          ...
          <input
            className="flex h-10 w-[450px] mr-[25rem] rounded-md bg-gray-100 px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
            type="text"
            placeholder="Serach"
          ></input>
        </div>
